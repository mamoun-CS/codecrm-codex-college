...
export class UnifyLeadsSchema1700000000003 implements MigrationInterface {
  name = 'UnifyLeadsSchema1700000000003';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // This migration is not reversible as it drops source tables
